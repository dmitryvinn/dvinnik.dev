            ...
            <div className="lg:col-span-7">
              <AnimatedSection>
                ...
                <div className="mt-6 space-y-4">
                  ...
                  <p className="nd-body text-base lg:text-lg">
                    Dmitry currently leads several developer advocacy efforts for major open source projects including PyTorch, React Native, Jest, and Docusaurus. He also built and launched two community learning platforms: Engineering Leadership Hub (engleader.dev), with 1,000+ curated resources for engineering managers, directors, VPs, and CTOs, and DevRel Academy (devrelacademy.com), with 2,800+ curated resources for developer advocates. His work spans the full spectrum of developer engagement — from creating educational content and delivering conference talks to collaborating with product teams on developer-facing resources for platforms like WhatsApp Business.
                  </p>
                  <p className="nd-body text-base lg:text-lg">
